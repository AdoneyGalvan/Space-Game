...
HD_PWD='C:/Users/AdoneyGalvan/Vivado Projects/GAME/GAME.runs/WINLOSE_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WINLOSE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WINLOSE.tcl
