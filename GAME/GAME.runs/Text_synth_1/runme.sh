...
HD_PWD='C:/Users/AdoneyGalvan/Vivado Projects/GAME/GAME.runs/Text_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Text.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Text.tcl
