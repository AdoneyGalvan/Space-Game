...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force SPACE_GAME_placed.dcp
  create_report "impl_1_place_report_io_0" "report_io -file SPACE_GAME_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file SPACE_GAME_utilization_placed.rpt -pb SPACE_GAME_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -file SPACE_GAME_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_1_route_report_power_0" "report_power -file SPACE_GAME_power_routed.rpt -pb SPACE_GAME_power_summary_routed.pb -rpx SPACE_GAME_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file SPACE_GAME_route_status.rpt -pb SPACE_GAME_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -file SPACE_GAME_timing_summary_routed.rpt -warn_on_violation  -rpx SPACE_GAME_timing_summary_routed.rpx"
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file SPACE_GAME_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file SPACE_GAME_clock_utilization_routed.rpt"
  close_msg_db -file route_design.pb
} RESULT]
if {$rc} {
  write_checkpoint -force SPACE_GAME_routed_error.dcp
...
set rc [catch {
  ...
  set_property XPM_LIBRARIES XPM_MEMORY [current_project]
  catch { write_mem_info -force SPACE_GAME.mmi }
  write_bitstream -force SPACE_GAME.bit 
  catch {write_debug_probes -quiet -force SPACE_GAME}
  catch {file copy -force SPACE_GAME.ltx debug_nets.ltx}
