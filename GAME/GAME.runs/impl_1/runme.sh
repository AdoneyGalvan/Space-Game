...
HD_PWD='C:/Users/AdoneyGalvan/Vivado Projects/GAME/GAME.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPACE_GAME.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPACE_GAME.tcl -notrace
