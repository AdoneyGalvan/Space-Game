...
HD_PWD='C:/Users/AdoneyGalvan/Vivado Projects/GAME/GAME.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPACE_GAME.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPACE_GAME.tcl
