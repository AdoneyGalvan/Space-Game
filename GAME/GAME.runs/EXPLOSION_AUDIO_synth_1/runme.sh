...
HD_PWD='C:/Users/AdoneyGalvan/Vivado Projects/GAME/GAME.runs/EXPLOSION_AUDIO_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EXPLOSION_AUDIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EXPLOSION_AUDIO.tcl
